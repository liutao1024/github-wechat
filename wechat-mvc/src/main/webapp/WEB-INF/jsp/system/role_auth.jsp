					...
					<div class="col-md-12">
						<div class="table-container" id="add_btn_set">
							<div class='table-actions-wrapper'>
								<span></span>
								<button id='add_Auth_btn' class='btn btn-sm green table-group-action-submit'>新增</button>
							</div>
							<table class="table table-striped table-bordered table-hover" id="role_auth_ajax">
								<thead>
									...
									<tr role="row" class="filter">
										<td><input type="hidden" class="form-control form-filter input-sm" id="q_regist_cd" /></td>
										<td><input type="hidden" class="form-control form-filter input-sm" id="q_auth_type" /></td>
										<td><input type="hidden" class="form-control form-filter input-sm" id="q_role_cd" /></td>
										<td><input type="text" class="form-control form-filter input-sm" name="q_auth_cd" /></td>
										<td>
