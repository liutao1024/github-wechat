...
<html>
	<head>
		...
		<link href="${ctx}/admin/styles/css/intran.css" type="text/css" rel="stylesheet"/>
		<link href="${ctx}/admin/styles/bootstrap-datepicker/css/datepicker3.css" rel="stylesheet" type="text/css"/>
		<link href="${ctx}/admin/styles/bootstrap-fileinput/bootstrap-fileinput.css" rel="stylesheet" type="text/css"/>
	...
	<body>
		...
		<div class="page-header">
			<div class="page-header-top">
				<div class="container">
					<!-- BEGIN LOGO -->
					<div class="page-logo">
						<img src="${ctx}/admin/styles/layout/img/logo-default.png" alt="logo" title="首页" class="logo-default">
					</div>
					<!-- END LOGO -->
				...
				<div class="container">
					...
					<div id="DmModal" class="modal fade" tabindex="-1"
						...
						<div class="modal-body">
							...
							<a data-target="/bbs/waititems" href="#"
		...
		<script src="${ctx}/pages/login/auth.js" type="text/javascript"></script>
		<script src="${ctx}/pages/login/index.js" type="text/javascript"></script>
		<script>
